...
Private Function fluentTester( _
    ...
    Select Case ucaseFunctionName
        Case UCase("Alphabetic")
            Call VBA.Interaction.CallByName(fluentInputShould.Be, functionName, VBA.VbCallType.VbMethod)
        Case UCase("Alphanumeric")
            Call VBA.Interaction.CallByName(fluentInputShould.Be, functionName, VBA.VbCallType.VbMethod)
        Case UCase("Between")
            Call VBA.Interaction.CallByName(fluentInputShould.Be, functionName, VBA.VbCallType.VbMethod, lowerVal, higherVal)
        Case UCase("Contain")
            Call VBA.Interaction.CallByName(fluentInputShould, functionName, VBA.VbCallType.VbMethod, testingInput)
        Case UCase("DepthCountOf")
            Call VBA.Interaction.CallByName(fluentInputShould.Have, functionName, VBA.VbCallType.VbMethod, testingInput)
        Case UCase("Elements")
        ...
        Case UCase("ErrorNumberOf")
            Call VBA.Interaction.CallByName(fluentInputShould.Have, functionName, VBA.VbCallType.VbMethod, testingInput)
        Case UCase("EqualTo")
            Call VBA.Interaction.CallByName(fluentInputShould.Be, functionName, VBA.VbCallType.VbMethod, testingInput)
        ...
        Case UCase("InDataStructures")
            If IsMissing(testingInput) Then
                Call VBA.Interaction.CallByName(fluentInputShould.Be, functionName, VBA.VbCallType.VbMethod, testingInput1, testingInput2, testingInput3, testingInput4, testingInput5, testingInput6, testingInput7, testingInput8, testingInput9, testingInput10, testingInput11, testingInput12, testingInput13, testingInput14, testingInput15, testingInput16, testingInput17, testingInput18, testingInput19, testingInput20, testingInput21, testingInput22, testingInput23, testingInput24, testingInput25, testingInput26, testingInput27, testingInput28, testingInput29, testingInput30)
            Else
                Call VBA.Interaction.CallByName(fluentInputShould.Be, functionName, VBA.VbCallType.VbMethod, testingInput)
            End If
        Case UCase("LengthBetween")
            Call VBA.Interaction.CallByName(fluentInputShould.Have, functionName, VBA.VbCallType.VbMethod, lowerVal, higherVal)
        Case UCase("LengthOf")
            Call VBA.Interaction.CallByName(fluentInputShould.Have, functionName, VBA.VbCallType.VbMethod, testingInput)
        Case UCase("LessThan")
            Call VBA.Interaction.CallByName(fluentInputShould.Be, functionName, VBA.VbCallType.VbMethod, testingInput)
        ...
        Case UCase("Procedure")
            Call VBA.Interaction.CallByName(fluentInputShould.Have, functionName, VBA.VbCallType.VbMethod, testingInput1, testingInput2)
